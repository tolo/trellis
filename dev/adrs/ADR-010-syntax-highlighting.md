...
## Status
Accepted (2026-07-08) — not yet implemented. Supersedes the unrecorded, de-facto
"vendored client-side Prism" approach currently in the `arbor` theme.
...
If/when scheduled (candidate: alongside or just after SDK Phase 5 CSS processing,
which already assumes `hljs-*` classes):
