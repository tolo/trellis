...
void main() {
  group('MapMessageSource', () {
    ...
    test('positional arg replacement {0}, {1}', () {
      ...
      expect(source.resolve('greeting', locale: 'en', args: ['Alice', 5]), 'Hello, Alice! You have 5 messages.');
    });
    ...
    test('missing positional arg — placeholder left as-is', () {
      ...
      expect(source.resolve('greeting', locale: 'en', args: ['Alice']), 'Hello, Alice and {1}!');
    });
