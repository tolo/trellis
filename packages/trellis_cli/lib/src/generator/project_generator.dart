...
import '../templates/about_page_template.dart';
...
class ProjectGenerator {
  ...
  /// 4 templates (layouts/base.html, pages/index.html, pages/about.html,
  /// partials/nav.html), static/styles.css, .gitignore, and
  ...
  Future<void> generate() async {
    ...
    await writer.writeFile('templates/pages/about.html', aboutPageTemplate());
