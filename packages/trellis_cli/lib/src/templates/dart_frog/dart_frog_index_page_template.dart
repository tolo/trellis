...
///
/// Uses a raw string to avoid conflicts with Trellis `${}` and `tl:*`
/// expressions.
String dartFrogIndexPageTemplate() => r'''<html tl:extends="layouts/base.html">
<body>
  <main tl:define="content">
    <div tl:fragment="page-content">
      <h1>Welcome to Trellis + Dart Frog</h1>
      <p>This is a Dart Frog web application with Trellis templates and HTMX
