/// Generates the static/styles.css content for a Relic + Trellis project.
///
/// Relic has no built-in static file handler, so the server serves this via
/// a dedicated route at `/styles.css`.
String relicStylesTemplate() => '''
/* Reset and base */
