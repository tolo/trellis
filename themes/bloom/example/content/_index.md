...
features:
  - icon: 🌱
    ...
    body: Start with a single note. Link, tag, and nest as your thinking evolves —
      structure emerges instead of being imposed.
  - icon: 🔒
    title: Yours, always
    body: Local-first storage and plain-text export. Your notes are files you own,
      not rows in someone else's database.
  - icon: ⚡
    title: Instant everything
    body: Full-text search across thousands of notes in milliseconds. No spinners,
      no waiting, no sync anxiety.
  - icon: 🔗
    title: Effortless links
    body: Type to connect ideas. Backlinks surface the context you forgot you had.
  - icon: 🎨
    title: Quietly beautiful
    body: A typographic canvas that gets out of your way. Light and dark, tuned for
...
pricing:
  ...
  tiers:
    ...
    - name: Grove
      price: $6
      period: /month
      description: For people who live in their notes.
      highlight: true
      badge: Most popular
      features:
    ...
    - name: Orchard
      price: $12
      period: /month
      description: For teams growing a shared brain.
      features:
        - Everything in Grove
        - Shared vaults
        - Team permissions
...
faq:
  ...
  items:
    - q: Is my data really local-first?
    ...
    - q: What happens if I cancel?
      a: Nothing happens to your notes — they're already on your disk. Paid features
        like sync simply switch off at the end of your billing period.
    - q: Do you train models on my notes?
      a: Never. Your notes are yours. We don't read them, sell them, or feed them to
        anything.

cta_band:
  title: Plant your first note today
  body: Free forever for solo thinkers. No credit card, no lock-in, no fuss.
  cta:
    label: Start free
    href: "#"
---
